...
public class AdapterDetail extends RecyclerView.Adapter<AdapterDetail.MyViewHolder> {
    ...
    public ArrayList<Shirt> getListShirt() {
        return listShirt;
    }

    public void setListShirt(ArrayList<Shirt> listShirt) {
    ...
    public void onBindViewHolder(@NonNull AdapterDetail.MyViewHolder holder, final int position) {
        Picasso.with(context)
                .load(getListShirt().get(position).getPhoto())
                .resize(150, 150)
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                txtNama.setText(getListShirt().get(position).getNama());
                txtDeskripsi.setText(getListShirt().get(position).getDescription());
                Picasso.with(context)
                        .load(getListShirt().get(position).getPhoto())
                        .resize(150, 150)
                        .placeholder(R.mipmap.ic_launcher)
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.imageShirt);
        }
    }
}
